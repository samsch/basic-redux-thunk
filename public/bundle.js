...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(/*! redux */ 159);
	
	var createStore = _require.createStore;
	var applyMiddleware = _require.applyMiddleware;
	
	var thunk = __webpack_require__(/*! redux-thunk */ 169);
	var createLogger = __webpack_require__(/*! redux-logger */ 170);
	
	var _require2 = __webpack_require__(/*! react-redux */ 171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _combineReducers = __webpack_require__(/*! ./combineReducers */ 164);
	...
	var _applyMiddleware = __webpack_require__(/*! ./applyMiddleware */ 167);
	
	var _applyMiddleware2 = _interopRequireDefault(_applyMiddleware);
	
	var _compose = __webpack_require__(/*! ./compose */ 168);
	
	var _compose2 = _interopRequireDefault(_compose);
	
	var _warning = __webpack_require__(/*! ./utils/warning */ 165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(/*! ./_isHostObject */ 162),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Provider = __webpack_require__(/*! ./components/Provider */ 172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(/*! ../utils/storeShape */ 173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(/*! ../actions/UpdateAction */ 181);
	
	var UPDATE_APP_NAME = _require.UPDATE_APP_NAME;
	
	
	var nameReducer = function nameReducer() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? 'Redux App!' : arguments[0];
	    var action = arguments[1];
...
/* 181 */
/*!*************************************!*\
  !*** ./src/actions/UpdateAction.js ***!
  \*************************************/
/***/ function(module, exports) {

	'use strict';
	
	var UPDATE_APP_NAME = 'actions/UpdateAction/UPDATE_APP_NAME';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(/*! react-redux */ 171);
	
	var connect = _require.connect;
	
	var PropTypes = React.PropTypes;
	
	var _require2 = __webpack_require__(/*! ../actions/UpdateAction */ 181);
	
	var updateName = _require2.updateName;
	
	var _require3 = __webpack_require__(/*! ../actions/AsyncData */ 183);
	
	var getData = _require3.getData;
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    null,
	                    'Change the app name: ',
	                    React.createElement('input', { type: 'text', value: this.props.appName, onChange: function onChange(ev) {
	                            return _this.props.dispatch(updateName(ev.target.value));
	                        } })
	                )
	            ),
	            React.createElement(
	                ...
	                null,
	                function () {
	                    if (!_this.props.asyncData) {
	                        return React.createElement(
	                            'button',
	                            { onClick: function onClick() {
	                                    return _this.props.dispatch(getData());
	                                } },
	                            'Click to load data'
	                        );
	                    }
	                    if (_this.props.asyncData.loading) {
	                        return 'Loading...';
	                    }
	                    return _this.props.asyncData.data;
	                }()
	            )
	        );
	    }
